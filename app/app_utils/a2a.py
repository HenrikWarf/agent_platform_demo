...
def _resolve_app_url(app_url: str | None) -> str:
    ...
    # Not GEMINI_LOCATION: the agent pins it to "global", which would build
    # an invalid "global-aiplatform.googleapis.com" URL.
    location = os.getenv("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION") or os.getenv("GCP_REGION", "us-central1")
