#!/usr/bin/env python3
"""
Read-Only SQL Safety Validator for ICA Analytics Agent.
...
ALLOWED_DATASET = "agent-demo-09.marketing_analytics_ica"
...
def validate_sql(query: str) -> str:
    ...
    if "marketing_analytics_ica" not in query:
...
if __name__ == "__main__":
    sql = sys.argv[1] if len(sys.argv) > 1 else "SELECT COUNT(*) FROM `agent-demo-09.marketing_analytics_ica.customer_demographics_360`"
